...
**Состояние:** Поставка `v0-2-14` / CLI `0.2.14` активирована из проверенного коммита; [запись выпуска](docs/releases/v0-2-14.md). [Каталог спек](specs/README.md), связи, теги и явный запуск проверок доступны в активной Поставке. Старые OpenSpec-материалы сохранены. Авторский текст следует языку проекта. Установленную версию показывает `global-status`; маршрут — в [GLOBAL](docs/workflow/GLOBAL.md).
