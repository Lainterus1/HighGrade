...
**Состояние:** глобальная поставка v0-2-1 реализована и проходит выпускную проверку. Прежний P0–P6-кандидат копировал четыре навыка и CLI в каждый проект; его испытания остаются историческим доказательством, но не подтверждают новый маршрут. Согласованное поведение — в [глобальном контракте](docs/workflow/GLOBAL.md), текущая работа — в [плане](docs/plans/2026-09-23-global-workflow.md) и [состоянии](docs/plans/2026-09-23-global-workflow.state.md).
