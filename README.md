...
**Состояние:** выпуск `v0-2-11` / CLI `0.2.11` активирован локально; [запись выпуска](docs/releases/v0-2-11.md). Он уточняет выбор кандидата Update, повтор установленного состава и диагностику после сбоя. Текущую установленную версию проверяет `global-status`. Действующий маршрут — в [глобальном контракте](docs/workflow/GLOBAL.md).
