...
**Состояние:** Поставка `v0-2-13` / CLI `0.2.13` активирована из проверенного коммита; [запись выпуска](docs/releases/v0-2-13.md). Кандидат v0-2-14 добавляет [каталог спек](specs/README.md), связи, теги и запуск проверок; ещё не активирован. Старые OpenSpec-материалы сохранены. Авторский текст следует языку проекта. Установленную версию показывает `global-status`; маршрут — в [GLOBAL](docs/workflow/GLOBAL.md).
