...
План: `docs/plans/2026-09-25-target-layout.md`, версия 2
...
Next: проверить состав файлов, создать локальный коммит HG-0019, собрать кандидат из его SHA и выполнить маршрут активации; затем отправить выбранный коммит в origin/main
Blockers: none
...
- T5: IN_PROGRESS; автор поручил локальное утверждение, активацию и push после проверок. Удалённый `origin/main` до коммита совпадает с исходным HEAD `88b4c23427142f53e39432b430181565e971bcee`.
