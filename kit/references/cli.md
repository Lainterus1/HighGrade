...
& '<кандидат>/target/release/highgrade.exe' global-update --profile '<домашний-каталог>' --rollback '<прежняя-версия>'
```
